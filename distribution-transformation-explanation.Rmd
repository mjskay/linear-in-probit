...
plot_lpr_grid_probit = lpr_grid |>
  ...
  scale_x_continuous() + 
  scale_y_continuous() + 
  scale_color_gradient(low = Color_Dict$dark_gradient, high = Color_Dict$para) + 
...
combined <- ggarrange(plot_lpr_grid_probit +
   ...
   ggsave(combined, file = "~/Documents/Github/Bias-correcion-paper/fig/linear-in-probit-f.pdf", width = 350, height = 720, scale = 4, units = 'px')
} else { 
